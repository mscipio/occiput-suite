...
from ..Visualization.Visualization import MultipleVolumes
...
class RigidTransformationSSD():
    ...
    def _contruct_ilang_model(self):
        ...
        self.graph.add_dependence(self.ilang_model,
    ...
    def estimate_transformation(self, method=None, iterations=30000, trace=True, parameters=None,
    ...
    def display(self, axis=0, shrink=256, rotate=90, subsample_slices=4, scale_factors=None, open_browser=False):
        ...
        D = MultipleVolumes([resampled, self.target], axis, shrink, rotate, subsample_slices, scale_factors,
                            open_browser)
        return D.display()
