...
class Motion_Sensor:
    ...
    def plot_motion(self, save_to_file=None, extract_events_threshold=THRESHOLD_MM, method='box', box_min=BOX_MIN,
                    box_max=BOX_MAX, min_duration=10, line_color=LINE_COLOR):
