...
class MR_Dynamic_Gaussian(Model):
    variables = {'x': 'continuous', 'sigma': 'continuous', 'roi_1': 'continuous', 'roi_1': 'continuous',
                 'k_1': 'continuous', 'k_2': 'continuous'}
    dependencies = [['x', 'k_1', 'directed'], ['x', 'k_2', 'directed'], ['sigma', 'k_1', 'directed'],
                    ['sigma', 'k_2', 'directed'], ['roi_1', 'k_1', 'directed'], ['roi_2', 'k_2', 'directed']]
