...
class MR_Dynamic_Scan:
            ...
            for framei in range(n_frames):
                ...
                if use_frame:
                    ...
                    if framei == 0:
                        ...
                        M = self._affine
                        image_tr = self._transform_image(image, M, interpolation_space=interpolation_space,
                    ...
                    if framei == 0:
                        ...
                        grad += self._transform_image(grad_tr, M.inverse, interpolation_space=interpolation_space,
                                                      interpolation_mode=interpolation_mode)
            image_abs = abs(image)
            kernel = -ones((3, 3, 3))
            kernel[1, 1, 1] = 26
    ...
    def _transform_image(self, image, affine, interpolation_space=INTERPOLATION_COMPLEXPLANE,
