...
DEFAULT_PROJECTION_PARAMETERS = {
    ...
    "gpu_acceleration": 1,
    # affects performance only, between 1 and 6; 2 and 5 are normally the best
    # value
    "direction": 7,
...
class ProjectionParameters(object):
    ...
    def load_from_dictionary(self, dictionary):
        ...
        # measure as the size of the imaging volume (activity_size and
        # attenuation_size))
        ...
        # Direction parameter for the projector and b-proj.it affects
        # performance only; 2 and 5 usual best values.
...
class BackprojectionParameters(ProjectionParameters):
    ...
    # Note: this seems unfinished, but it inherits all that is necessary from
    # ProjectionParameters
