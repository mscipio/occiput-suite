...
from ..Visualization.Visualization import MultipleVolumes, VolumeRenderer, ipy_table, has_ipy_table
...
class Image3D(ImageND):
    ...
    def display_with(self, other_images, axis=0, shrink=None, rotate=None, subsample_slices=None, scales=None,
                     open_browser=None):
