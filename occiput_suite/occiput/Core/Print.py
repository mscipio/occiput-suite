...
def pretty_print_large_number(number):
    """Given a large number, it returns a string of the sort:
      '10.5 Thousand' or '12.3 Billion'. """
...
def print_percentage(number):
    """Given a number between 0 and 1, it returns a
     string indicating percentage: e.g. 10.2 %%"""
